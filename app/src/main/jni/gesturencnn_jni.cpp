...
Java_com_lee_edu_mydemo_Utils_SqueezeNcnn_InitNcnn(JNIEnv *env, jobject instance,
	...
	std::vector<std::string> param_files = {
		tGestureModelDir+"/gesture.param",

	};

	std::vector<std::string> bin_files = {
		tGestureModelDir+"/gesture.bin",
...
JNIEXPORT void  Java_com_lee_edu_mydemo_Utils_SqueezeNcnn_Detect( JNIEnv *env,
                                                                                      jobject /* this */,
                                                                                      jfloatArray I,
                                                                                      jfloatArray Q ,
